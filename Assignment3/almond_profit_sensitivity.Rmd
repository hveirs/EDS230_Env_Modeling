...
# Extract yearly results from the list
yearly_profit <-  map_df(results,`[`, c('exp_profit'))

# We can add the parameter values for each run
yearly_profit_parms = cbind.data.frame(yearly_profit, parms)
